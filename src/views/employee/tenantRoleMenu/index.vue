  ...
  export default {
    ...
    methods: {
      ...
      handleView(index, row) {
        this.$router.push({path: '/employee/viewTenantRoleMenu', query: {id: row.id, tenantId:this.tenantId, moduleId:this.moduleId}})
      },
      handleUpdate(index, row) {
        this.$router.push({path: '/employee/updateTenantRoleMenu', query: {id: row.id, tenantId:this.tenantId}})
      },
      ...
      addTenantRoleMenu() {
        this.$router.push({path: '/employee/addTenantRoleMenu', query: {tenantId:this.tenantId,moduleId:this.moduleId}})
      }
    }
  }
</script>
