  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="tenantRoleTable"
        ...
        <el-table-column label="角色名称" width="100" align="left" header-align="center">
  ...
  export default {
    ...
    methods: {
      ...
      handleUpdate(index, row) {
        this.$router.push({path: '/mbg/updateTenantRole', query: {id: row.id}})
      },
      ...
      addTenantRole() {
        this.$router.push({path: '/mbg/addTenantRole'})
      }
    }
  }
</script>
