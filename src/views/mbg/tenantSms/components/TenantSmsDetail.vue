<template> 
  <el-card class="form-container" shadow="never">
    <el-form :model="tenantSms" :rules="rules" ref="tenantSmsFrom" label-width="150px">
      ...
      <el-form-item label="短信SP服务商：" prop="smsSpService">
        <el-input v-model="tenantSms.smsSpService"></el-input>
      </el-form-item>
      <el-form-item label="是否启用抄表账单通知短信（启用/不启用）：" prop="smsReadSendOn">
        <el-switch
      ...
      <el-form-item label="是否启用缴费成功通知短信（启用/不启用）：" prop="smsChargeSendOn">
        <el-switch
      ...
      <el-form-item label="是否启用欠费通知短信（启用/不启用）：" prop="smsQfSendOn">
        <el-switch
      ...
      <el-form-item label="欠费通知短信发送间隔天数（欠费多少天后，催费多少天后仍然未缴）：" prop="smsQfSendAfterDays">
        <el-input-number v-model="tenantSms.smsQfSendAfterDays"></el-input-number>
      </el-form-item>
      <el-form-item>
