  ...
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
        <div>
          ...
          <el-button
            style="float: right"
            @click="searchDevReadCurrHisList()"
            type="primary"
            size="small">
            查询结果
          </el-button>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button
        class="btn-add"
        @click="addDevReadCurrHis()"
        size="mini">
        添加
      </el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="devReadCurrHisTable"
                :data="list"
                style="width: 100%"
...
<script>
  import {fetchList, deleteDevReadCurrHis} from '@/api/devReadCurrHis'
  ...
  export default {
    ...
    methods: {
      ...
      handleUpdate(index, row) {
        this.$router.push({path: '/cust/updateDevReadCurrHis', query: {id: row.id}})
      },
      handleDelete(index, row) {
        this.$confirm('是否要删除该历史抄表信息', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(() => {
          deleteDevReadCurrHis(row.id).then(response => {
            this.$message({
              message: '删除成功',
              type: 'success',
              duration: 1000
      ...
      addDevReadCurrHis() {
        this.$router.push({path: '/cust/addDevReadCurrHis'})
      }
    }
  }
</script>
