  ...
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
        ...
        <div style="margin-top: 15px">
          <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
            ...
            <el-form-item label="依赖模块编码：">
              <el-input style="width: 203px" v-model="listQuery.relyId" placeholder="依赖模块编码"></el-input>
            </el-form-item>
            <el-form-item label="模块名称：">
              <el-input style="width: 203px" v-model="listQuery.moduleNameLike" placeholder="模块名称"></el-input>
            </el-form-item>
    ...
    <div class="table-container">
      <el-table ref="moduleInfoTable"
        ...
        <el-table-column label="依赖模块编码" width="100" align="left" header-align="center">
...
<script>
  import {fetchList, deleteModuleInfo, updateBasicOn, updateAdvanceOn, updateUltimateOn, updateModuleReleaseOn} from '@/api/moduleInfo'
  ...
  export default {
    ...
    methods: {
      ...
      handleView(index, row) {
        this.$router.push({path: '/module/viewModuleInfo', query: {id: row.id}})
      },
      handleUpdate(index, row) {
        this.$router.push({path: '/module/updateModuleInfo', query: {id: row.id}})
      },
      ...
      addModuleInfo() {
        this.$router.push({path: '/module/addModuleInfo'})
      }
    }
  }
</script>
