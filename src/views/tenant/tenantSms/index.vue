  ...
  <div class="app-container">
        ...
        <div style="margin-top: 15px">
          <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
            ...
            <el-form-item label="签名：">
              <el-input style="width: 203px" v-model="listQuery.smsSignature" placeholder="签名"></el-input>
            </el-form-item>
            <el-form-item label="SP服务商：">
              <el-input style="width: 203px" v-model="listQuery.smsSpService" placeholder="SP服务商"></el-input>
            </el-form-item>
            <el-form-item label="启用抄表账单通知：">
            ...
            <el-form-item label="欠费通知短信发送间隔天数：">
              <el-input style="width: 203px" v-model="listQuery.smsQfSendAfterDays" placeholder="欠费通知短信发送间隔天数"></el-input>
            </el-form-item>
          </el-form>
        </div>
    </el-card>
    ...
    <div class="table-container">
      <el-table ref="tenantSmsTable"
        ...
        <el-table-column label="签名" width="100" align="left" header-align="center">
          <template slot-scope="scope">{{scope.row.smsSignature}}</template>
        </el-table-column>
        <el-table-column label="SP服务商" width="" align="left" header-align="center">
          <template slot-scope="scope">{{scope.row.smsSpService}}</template>
        </el-table-column>
        <el-table-column label="启用抄表账单通知" width="100" align="left" header-align="center">
        ...
        <el-table-column label="启用缴费成功通知" width="100" align="left" header-align="center">
          <template slot-scope="scope">
            <el-switch
        ...
        <el-table-column label="启用欠费通知" width="100" align="left" header-align="center">
          <template slot-scope="scope">
            <el-switch
        ...
        <el-table-column label="欠费通知短信发送间隔天数" width="100" align="left" header-align="center">
  ...
  export default {
    ...
    methods: {
      ...
      handleView(index, row) {
        this.$router.push({path: '/tenant/viewTenantSms', query: {id: row.id}})
      },
      handleUpdate(index, row) {
        this.$router.push({path: '/tenant/updateTenantSms', query: {id: row.id}})
      },
      ...
      addTenantSms() {
        this.$router.push({path: '/tenant/addTenantSms'})
      }
    }
  }
</script>
