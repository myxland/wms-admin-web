  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="tenantCustType" :rules="rules" ref="tenantCustTypeFrom" label-width="150px">
      ...
      <el-form-item label="租户：" prop="tenantId">
        <el-select v-model="tenantCustType.tenantId" placeholder="请选择租户" :disabled="this.$route.query.tenantId?true:false" clearable>
                <el-option
  ...
  export default {
    ...
    created() {
      if (this.isEdit) {
          ...
          getTenantCustTypeByTenantId(this.$route.query.tenantId).then(response => {
	          this.tenantCustType = response.data;
        	});
        }
        
      }else{
        this.tenantCustType = Object.assign({},defaultTenantCustType,this.$route.query);
      }
