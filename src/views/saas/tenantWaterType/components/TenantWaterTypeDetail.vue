<template> 
  <el-card class="form-container" shadow="never">
    <el-form :model="tenantWaterType" :rules="rules" ref="tenantWaterTypeFrom" label-width="150px">
      <el-form-item label="用水类别ID：" prop="id">
        <el-input v-model="tenantWaterType.id" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="租户ID：" prop="tenantId">
        <el-select v-model="tenantWaterType.tenantId" placeholder="请选择租户ID" :disabled="this.$route.query.tenantId?true:false" clearable>
                <el-option
      ...
      <el-form-item label="上级用水类别编号：" prop="waterTypeParentId">
        <el-input v-model="tenantWaterType.waterTypeParentId"></el-input>
      </el-form-item>
      <el-form-item label="默认价格分类ID：" prop="defaultPriceTypeId">
        <el-input v-model="tenantWaterType.defaultPriceTypeId"></el-input>
      </el-form-item>
      <el-form-item>
